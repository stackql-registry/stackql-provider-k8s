--- 
title: horizontal_pod_autoscalers_status
hide_title: false
hide_table_of_contents: false
keywords:
  - horizontal_pod_autoscalers_status
  - autoscaling
  - k8s
...
Creates, updates, deletes, gets or lists a <code>horizontal_pod_autoscalers_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="horizontal_pod_autoscalers_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.autoscaling.horizontal_pod_autoscalers_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified HorizontalPodAutoscaler</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified HorizontalPodAutoscaler</td>
</tr>
<tr>
    ...
    <td>replace status of the specified HorizontalPodAutoscaler</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.autoscaling.horizontal_pod_autoscalers_status
...
```sql
UPDATE k8s.autoscaling.horizontal_pod_autoscalers_status
SET 
...
```sql
REPLACE k8s.autoscaling.horizontal_pod_autoscalers_status
SET 
