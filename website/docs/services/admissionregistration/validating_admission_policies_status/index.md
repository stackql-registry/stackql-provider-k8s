--- 
title: validating_admission_policies_status
hide_title: false
hide_table_of_contents: false
keywords:
  - validating_admission_policies_status
...
Creates, updates, deletes, gets or lists a <code>validating_admission_policies_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="validating_admission_policies_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.admissionregistration.validating_admission_policies_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified ValidatingAdmissionPolicy</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified ValidatingAdmissionPolicy</td>
</tr>
<tr>
    ...
    <td>replace status of the specified ValidatingAdmissionPolicy</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.admissionregistration.validating_admission_policies_status
...
```sql
UPDATE k8s.admissionregistration.validating_admission_policies_status
SET 
...
```sql
REPLACE k8s.admissionregistration.validating_admission_policies_status
SET 
