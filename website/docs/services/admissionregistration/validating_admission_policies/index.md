--- 
title: validating_admission_policies
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>validating_admission_policies</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="validating_admission_policies" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.admissionregistration.validating_admission_policies" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified ValidatingAdmissionPolicy</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind ValidatingAdmissionPolicy</td>
</tr>
<tr>
    ...
    <td>create a ValidatingAdmissionPolicy</td>
</tr>
<tr>
    ...
    <td>partially update the specified ValidatingAdmissionPolicy</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified ValidatingAdmissionPolicy</td>
</tr>
<tr>
    ...
    <td>delete a ValidatingAdmissionPolicy</td>
</tr>
<tr>
    ...
    <td>delete collection of ValidatingAdmissionPolicy</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.admissionregistration.validating_admission_policies
...
```sql
INSERT INTO k8s.admissionregistration.validating_admission_policies (
apiVersion,
kind,
metadata,
spec,
...
- name: validating_admission_policies
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the validating_admission_policies resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the validating_admission_policies resource.
    - name: apiVersion
...
```sql
UPDATE k8s.admissionregistration.validating_admission_policies
SET 
...
```sql
REPLACE k8s.admissionregistration.validating_admission_policies
SET 
apiVersion = '{{ apiVersion }}',
kind = '{{ kind }}',
metadata = '{{ metadata }}',
...
```sql
DELETE FROM k8s.admissionregistration.validating_admission_policies
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dryRun = '{{ dryRun }}'
