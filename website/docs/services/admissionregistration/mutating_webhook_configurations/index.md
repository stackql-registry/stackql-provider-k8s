--- 
title: mutating_webhook_configurations
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>mutating_webhook_configurations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="mutating_webhook_configurations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.admissionregistration.mutating_webhook_configurations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified MutatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind MutatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>create a MutatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>partially update the specified MutatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified MutatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>delete a MutatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>delete collection of MutatingWebhookConfiguration</td>
</tr>
</tbody>
</table>
...
metadata,
webhooks
FROM k8s.admissionregistration.mutating_webhook_configurations
...
```sql
INSERT INTO k8s.admissionregistration.mutating_webhook_configurations (
api_version,
kind,
metadata,
webhooks,
...
- name: mutating_webhook_configurations
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the mutating_webhook_configurations resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the mutating_webhook_configurations resource.
    - name: api_version
...
```sql
UPDATE k8s.admissionregistration.mutating_webhook_configurations
SET 
...
```sql
REPLACE k8s.admissionregistration.mutating_webhook_configurations
SET 
...
```sql
DELETE FROM k8s.admissionregistration.mutating_webhook_configurations
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
