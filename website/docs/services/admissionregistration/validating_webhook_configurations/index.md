--- 
title: validating_webhook_configurations
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>validating_webhook_configurations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="validating_webhook_configurations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.admissionregistration.validating_webhook_configurations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>webhooks is a list of webhooks and the affected resources and operations. (x-kubernetes-list-type: map, x-kubernetes-patch-merge-key: name, x-kubernetes-patch-strategy: merge)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>read the specified ValidatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind ValidatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>create a ValidatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>partially update the specified ValidatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified ValidatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>delete a ValidatingWebhookConfiguration</td>
</tr>
<tr>
    ...
    <td>delete collection of ValidatingWebhookConfiguration</td>
</tr>
</tbody>
</table>
...
metadata,
webhooks
FROM k8s.admissionregistration.validating_webhook_configurations
...
```sql
INSERT INTO k8s.admissionregistration.validating_webhook_configurations (
apiVersion,
kind,
metadata,
webhooks,
...
- name: validating_webhook_configurations
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the validating_webhook_configurations resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the validating_webhook_configurations resource.
    - name: apiVersion
...
```sql
UPDATE k8s.admissionregistration.validating_webhook_configurations
SET 
...
```sql
REPLACE k8s.admissionregistration.validating_webhook_configurations
SET 
apiVersion = '{{ apiVersion }}',
kind = '{{ kind }}',
metadata = '{{ metadata }}',
...
```sql
DELETE FROM k8s.admissionregistration.validating_webhook_configurations
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dryRun = '{{ dryRun }}'
