--- 
title: mutating_admission_policy_bindings
hide_title: false
hide_table_of_contents: false
keywords:
  - mutating_admission_policy_bindings
...
Creates, updates, deletes, gets or lists a <code>mutating_admission_policy_bindings</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="mutating_admission_policy_bindings" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.admissionregistration.mutating_admission_policy_bindings" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified MutatingAdmissionPolicyBinding</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind MutatingAdmissionPolicyBinding</td>
</tr>
<tr>
    ...
    <td>create a MutatingAdmissionPolicyBinding</td>
</tr>
<tr>
    ...
    <td>partially update the specified MutatingAdmissionPolicyBinding</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified MutatingAdmissionPolicyBinding</td>
</tr>
<tr>
    ...
    <td>delete a MutatingAdmissionPolicyBinding</td>
</tr>
<tr>
    ...
    <td>delete collection of MutatingAdmissionPolicyBinding</td>
</tr>
</tbody>
</table>
...
metadata,
spec
FROM k8s.admissionregistration.mutating_admission_policy_bindings
...
```sql
INSERT INTO k8s.admissionregistration.mutating_admission_policy_bindings (
api_version,
kind,
metadata,
spec,
...
- name: mutating_admission_policy_bindings
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the mutating_admission_policy_bindings resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the mutating_admission_policy_bindings resource.
    - name: api_version
...
```sql
UPDATE k8s.admissionregistration.mutating_admission_policy_bindings
SET 
...
```sql
REPLACE k8s.admissionregistration.mutating_admission_policy_bindings
SET 
...
```sql
DELETE FROM k8s.admissionregistration.mutating_admission_policy_bindings
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
