...
Creates, updates, deletes, gets or lists a <code>custom_resource_definitions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="custom_resource_definitions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.apiextensions.custom_resource_definitions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified CustomResourceDefinition</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind CustomResourceDefinition</td>
</tr>
<tr>
    ...
    <td>create a CustomResourceDefinition</td>
</tr>
<tr>
    ...
    <td>partially update the specified CustomResourceDefinition</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified CustomResourceDefinition</td>
</tr>
<tr>
    ...
    <td>delete a CustomResourceDefinition</td>
</tr>
<tr>
    ...
    <td>delete collection of CustomResourceDefinition</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.apiextensions.custom_resource_definitions
...
```sql
INSERT INTO k8s.apiextensions.custom_resource_definitions (
api_version,
kind,
metadata,
spec,
...
- name: custom_resource_definitions
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the custom_resource_definitions resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the custom_resource_definitions resource.
    - name: api_version
...
```sql
UPDATE k8s.apiextensions.custom_resource_definitions
SET 
...
```sql
REPLACE k8s.apiextensions.custom_resource_definitions
SET 
...
```sql
DELETE FROM k8s.apiextensions.custom_resource_definitions
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
