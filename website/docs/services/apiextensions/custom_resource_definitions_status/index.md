--- 
title: custom_resource_definitions_status
hide_title: false
hide_table_of_contents: false
keywords:
  - custom_resource_definitions_status
  - apiextensions
  - k8s
...
Creates, updates, deletes, gets or lists a <code>custom_resource_definitions_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="custom_resource_definitions_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.apiextensions.custom_resource_definitions_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified CustomResourceDefinition</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified CustomResourceDefinition</td>
</tr>
<tr>
    ...
    <td>replace status of the specified CustomResourceDefinition</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.apiextensions.custom_resource_definitions_status
...
```sql
UPDATE k8s.apiextensions.custom_resource_definitions_status
SET 
...
```sql
REPLACE k8s.apiextensions.custom_resource_definitions_status
SET 
