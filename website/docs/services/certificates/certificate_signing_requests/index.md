...
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.certificates.certificate_signing_requests" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified CertificateSigningRequest</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind CertificateSigningRequest</td>
</tr>
<tr>
    ...
    <td>create a CertificateSigningRequest</td>
</tr>
<tr>
    ...
    <td>partially update the specified CertificateSigningRequest</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified CertificateSigningRequest</td>
</tr>
<tr>
    ...
    <td>delete a CertificateSigningRequest</td>
</tr>
<tr>
    ...
    <td>delete collection of CertificateSigningRequest</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.certificates.certificate_signing_requests
...
```sql
INSERT INTO k8s.certificates.certificate_signing_requests (
api_version,
kind,
metadata,
spec,
...
- name: certificate_signing_requests
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the certificate_signing_requests resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the certificate_signing_requests resource.
    - name: api_version
...
```sql
UPDATE k8s.certificates.certificate_signing_requests
SET 
...
```sql
REPLACE k8s.certificates.certificate_signing_requests
SET 
...
```sql
DELETE FROM k8s.certificates.certificate_signing_requests
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
