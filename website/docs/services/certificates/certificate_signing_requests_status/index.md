--- 
title: certificate_signing_requests_status
hide_title: false
hide_table_of_contents: false
keywords:
  - certificate_signing_requests_status
  - certificates
  - k8s
...
Creates, updates, deletes, gets or lists a <code>certificate_signing_requests_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="certificate_signing_requests_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.certificates.certificate_signing_requests_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified CertificateSigningRequest</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified CertificateSigningRequest</td>
</tr>
<tr>
    ...
    <td>replace status of the specified CertificateSigningRequest</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.certificates.certificate_signing_requests_status
...
```sql
UPDATE k8s.certificates.certificate_signing_requests_status
SET 
...
```sql
REPLACE k8s.certificates.certificate_signing_requests_status
SET 
