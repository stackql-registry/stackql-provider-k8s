...
Creates, updates, deletes, gets or lists a <code>cluster_roles</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="cluster_roles" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.rbac.cluster_roles" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><CopyableCode code="aggregation_rule" /></td>
    <td><code>object</code></td>
    <td>AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be stomped by the controller. (wire: aggregationRule)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>Rules holds all the PolicyRules for this ClusterRole (x-kubernetes-list-type: atomic)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>read the specified ClusterRole</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind ClusterRole</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified ClusterRole</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified ClusterRole</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of ClusterRole</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.rbac.cluster_roles (
aggregation_rule,
api_version,
kind,
metadata,
...
- name: cluster_roles
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the cluster_roles resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the cluster_roles resource.
...
```sql
REPLACE k8s.rbac.cluster_roles
SET 
...
```sql
DELETE FROM k8s.rbac.cluster_roles
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
