...
Creates, updates, deletes, gets or lists a <code>cluster_role_bindings</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="cluster_role_bindings" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.rbac.cluster_role_bindings" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="role_ref" /></td>
    <td><code>object</code></td>
    <td>RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error. This field is immutable. (x-kubernetes-map-type: atomic) (wire: roleRef)</td>
</tr>
<tr>
    <td><CopyableCode code="subjects" /></td>
    <td><code>array</code></td>
    <td>Subjects holds references to the objects the role applies to. (x-kubernetes-list-type: atomic)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>read the specified ClusterRoleBinding</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind ClusterRoleBinding</td>
</tr>
<tr>
    <td><a href="#create"><CopyableCode code="create" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-role_ref"><code>role_ref</code></a></td>
    ...
    <td>create a ClusterRoleBinding</td>
</tr>
<tr>
    ...
    <td>partially update the specified ClusterRoleBinding</td>
</tr>
<tr>
    <td><a href="#replace"><CopyableCode code="replace" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-role_ref"><code>role_ref</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified ClusterRoleBinding</td>
</tr>
<tr>
    ...
    <td>delete a ClusterRoleBinding</td>
</tr>
<tr>
    ...
    <td>delete collection of ClusterRoleBinding</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.rbac.cluster_role_bindings (
api_version,
kind,
metadata,
role_ref,
...
- name: cluster_role_bindings
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the cluster_role_bindings resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the cluster_role_bindings resource.
    - name: api_version
...
```sql
UPDATE k8s.rbac.cluster_role_bindings
SET 
...
```sql
REPLACE k8s.rbac.cluster_role_bindings
SET 
...
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND role_ref = '{{ role_ref }}' --required
AND dry_run = '{{ dry_run}}'
AND field_manager = '{{ field_manager}}'
AND field_validation = '{{ field_validation}}'
AND pretty = '{{ pretty}}'
...
```sql
DELETE FROM k8s.rbac.cluster_role_bindings
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
