...
Creates, updates, deletes, gets or lists a <code>cron_jobs</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="cron_jobs" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.batch.cron_jobs" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified CronJob</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified CronJob</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified CronJob</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of CronJob</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.batch.cron_jobs (
apiVersion,
kind,
metadata,
spec,
...
- name: cron_jobs
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the cron_jobs resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the cron_jobs resource.
    - name: cluster_addr
...
```sql
DELETE FROM k8s.batch.cron_jobs
WHERE name = '{{ name }}' --required
AND namespace = '{{ namespace }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
