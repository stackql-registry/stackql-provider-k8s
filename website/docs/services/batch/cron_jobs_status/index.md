...
Creates, updates, deletes, gets or lists a <code>cron_jobs_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="cron_jobs_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.batch.cron_jobs_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified CronJob</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified CronJob</td>
</tr>
<tr>
    ...
    <td>replace status of the specified CronJob</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.batch.cron_jobs_status
...
```sql
UPDATE k8s.batch.cron_jobs_status
SET 
...
```sql
REPLACE k8s.batch.cron_jobs_status
SET 
