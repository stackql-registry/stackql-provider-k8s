...
Creates, updates, deletes, gets or lists a <code>pod_disruption_budgets</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pod_disruption_budgets" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.policy.pod_disruption_budgets" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified PodDisruptionBudget</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind PodDisruptionBudget</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified PodDisruptionBudget</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified PodDisruptionBudget</td>
</tr>
<tr>
    ...
    <td>delete a PodDisruptionBudget</td>
</tr>
<tr>
    ...
    <td>delete collection of PodDisruptionBudget</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.policy.pod_disruption_budgets
...
```sql
INSERT INTO k8s.policy.pod_disruption_budgets (
api_version,
kind,
metadata,
spec,
...
- name: pod_disruption_budgets
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the pod_disruption_budgets resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the pod_disruption_budgets resource.
    - name: cluster_addr
...
```sql
UPDATE k8s.policy.pod_disruption_budgets
SET 
...
```sql
REPLACE k8s.policy.pod_disruption_budgets
SET 
...
```sql
DELETE FROM k8s.policy.pod_disruption_budgets
WHERE name = '{{ name }}' --required
AND namespace = '{{ namespace }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
