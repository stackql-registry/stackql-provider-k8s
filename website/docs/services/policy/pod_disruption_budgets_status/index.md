--- 
title: pod_disruption_budgets_status
hide_title: false
hide_table_of_contents: false
keywords:
  - pod_disruption_budgets_status
  - policy
  - k8s
...
Creates, updates, deletes, gets or lists a <code>pod_disruption_budgets_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pod_disruption_budgets_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.policy.pod_disruption_budgets_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified PodDisruptionBudget</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified PodDisruptionBudget</td>
</tr>
<tr>
    ...
    <td>replace status of the specified PodDisruptionBudget</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.policy.pod_disruption_budgets_status
...
```sql
UPDATE k8s.policy.pod_disruption_budgets_status
SET 
...
```sql
REPLACE k8s.policy.pod_disruption_budgets_status
SET 
