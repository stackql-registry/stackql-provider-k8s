--- 
title: local_subject_access_reviews
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>local_subject_access_reviews</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="local_subject_access_reviews" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.authorization.local_subject_access_reviews" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>create a LocalSubjectAccessReview</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.authorization.local_subject_access_reviews (
apiVersion,
kind,
metadata,
spec,
...
- name: local_subject_access_reviews
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the local_subject_access_reviews resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the local_subject_access_reviews resource.
    - name: cluster_addr
