--- 
title: self_subject_rules_reviews
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>self_subject_rules_reviews</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="self_subject_rules_reviews" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.authorization.self_subject_rules_reviews" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>create a SelfSubjectRulesReview</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.authorization.self_subject_rules_reviews (
apiVersion,
kind,
metadata,
spec,
...
- name: self_subject_rules_reviews
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the self_subject_rules_reviews resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the self_subject_rules_reviews resource.
    - name: apiVersion
