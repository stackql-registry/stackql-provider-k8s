...
Creates, updates, deletes, gets or lists a <code>subject_access_reviews</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="subject_access_reviews" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.authorization.subject_access_reviews" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>create a SubjectAccessReview</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.authorization.subject_access_reviews (
apiVersion,
kind,
metadata,
spec,
...
- name: subject_access_reviews
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the subject_access_reviews resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the subject_access_reviews resource.
    - name: apiVersion
