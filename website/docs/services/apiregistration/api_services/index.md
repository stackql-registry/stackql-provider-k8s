...
Creates, updates, deletes, gets or lists an <code>api_services</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="api_services" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.apiregistration.api_services" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified APIService</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind APIService</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified APIService</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified APIService</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of APIService</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.apiregistration.api_services
...
```sql
INSERT INTO k8s.apiregistration.api_services (
api_version,
kind,
metadata,
spec,
...
- name: api_services
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the api_services resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the api_services resource.
    - name: api_version
...
```sql
UPDATE k8s.apiregistration.api_services
SET 
...
```sql
REPLACE k8s.apiregistration.api_services
SET 
...
```sql
DELETE FROM k8s.apiregistration.api_services
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
