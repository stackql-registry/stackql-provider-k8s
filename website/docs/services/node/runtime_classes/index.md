...
Creates, updates, deletes, gets or lists a <code>runtime_classes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="runtime_classes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.node.runtime_classes" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="overhead" /></td>
    <td><code>object</code></td>
...
<tr>
    ...
    <td>read the specified RuntimeClass</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind RuntimeClass</td>
</tr>
<tr>
    <td><a href="#create"><CopyableCode code="create" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-handler"><code>handler</code></a></td>
...
<tr>
    ...
    <td>partially update the specified RuntimeClass</td>
</tr>
<tr>
    <td><a href="#replace"><CopyableCode code="replace" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-handler"><code>handler</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified RuntimeClass</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of RuntimeClass</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.node.runtime_classes (
apiVersion,
handler,
kind,
metadata,
...
- name: runtime_classes
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the runtime_classes resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the runtime_classes resource.
    - name: apiVersion
...
```sql
UPDATE k8s.node.runtime_classes
SET 
...
```sql
REPLACE k8s.node.runtime_classes
SET 
apiVersion = '{{ apiVersion }}',
handler = '{{ handler }}',
kind = '{{ kind }}',
...
```sql
DELETE FROM k8s.node.runtime_classes
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dryRun = '{{ dryRun }}'
