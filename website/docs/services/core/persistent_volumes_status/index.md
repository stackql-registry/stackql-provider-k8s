--- 
title: persistent_volumes_status
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>persistent_volumes_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="persistent_volumes_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.persistent_volumes_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified PersistentVolume</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified PersistentVolume</td>
</tr>
<tr>
    ...
    <td>replace status of the specified PersistentVolume</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.core.persistent_volumes_status
...
```sql
UPDATE k8s.core.persistent_volumes_status
SET 
...
```sql
REPLACE k8s.core.persistent_volumes_status
SET 
