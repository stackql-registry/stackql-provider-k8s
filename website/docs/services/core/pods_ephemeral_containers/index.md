--- 
title: pods_ephemeral_containers
hide_title: false
hide_table_of_contents: false
keywords:
  - pods_ephemeral_containers
  - core
  - k8s
...
Creates, updates, deletes, gets or lists a <code>pods_ephemeral_containers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pods_ephemeral_containers" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.pods_ephemeral_containers" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read ephemeralcontainers of the specified Pod</td>
</tr>
<tr>
    ...
    <td>partially update ephemeralcontainers of the specified Pod</td>
</tr>
<tr>
    ...
    <td>replace ephemeralcontainers of the specified Pod</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.core.pods_ephemeral_containers
...
```sql
UPDATE k8s.core.pods_ephemeral_containers
SET 
...
```sql
REPLACE k8s.core.pods_ephemeral_containers
SET 
