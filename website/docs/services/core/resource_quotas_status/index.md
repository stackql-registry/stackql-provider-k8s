--- 
title: resource_quotas_status
hide_title: false
hide_table_of_contents: false
keywords:
  - resource_quotas_status
  - core
  - k8s
...
Creates, updates, deletes, gets or lists a <code>resource_quotas_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="resource_quotas_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.resource_quotas_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified ResourceQuota</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified ResourceQuota</td>
</tr>
<tr>
    ...
    <td>replace status of the specified ResourceQuota</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.core.resource_quotas_status
...
```sql
UPDATE k8s.core.resource_quotas_status
SET 
...
```sql
REPLACE k8s.core.resource_quotas_status
SET 
