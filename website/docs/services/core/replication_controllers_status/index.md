--- 
title: replication_controllers_status
hide_title: false
hide_table_of_contents: false
keywords:
  - replication_controllers_status
  - core
  - k8s
...
Creates, updates, deletes, gets or lists a <code>replication_controllers_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="replication_controllers_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.replication_controllers_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified ReplicationController</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified ReplicationController</td>
</tr>
<tr>
    ...
    <td>replace status of the specified ReplicationController</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.core.replication_controllers_status
...
```sql
UPDATE k8s.core.replication_controllers_status
SET 
...
```sql
REPLACE k8s.core.replication_controllers_status
SET 
