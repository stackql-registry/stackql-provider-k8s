...
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.resource_quotas" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified ResourceQuota</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind ResourceQuota</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified ResourceQuota</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified ResourceQuota</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of ResourceQuota</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.core.resource_quotas (
api_version,
kind,
metadata,
spec,
...
- name: resource_quotas
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the resource_quotas resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the resource_quotas resource.
    - name: cluster_addr
...
```sql
UPDATE k8s.core.resource_quotas
SET 
...
```sql
REPLACE k8s.core.resource_quotas
SET 
...
```sql
DELETE FROM k8s.core.resource_quotas
WHERE name = '{{ name }}' --required
AND namespace = '{{ namespace }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
