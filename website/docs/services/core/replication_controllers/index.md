...
Creates, updates, deletes, gets or lists a <code>replication_controllers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="replication_controllers" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.replication_controllers" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified ReplicationController</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind ReplicationController</td>
</tr>
<tr>
    ...
    <td>create a ReplicationController</td>
</tr>
<tr>
    ...
    <td>partially update the specified ReplicationController</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified ReplicationController</td>
</tr>
<tr>
    ...
    <td>delete a ReplicationController</td>
</tr>
<tr>
    ...
    <td>delete collection of ReplicationController</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.core.replication_controllers
...
```sql
INSERT INTO k8s.core.replication_controllers (
apiVersion,
kind,
metadata,
spec,
...
- name: replication_controllers
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the replication_controllers resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the replication_controllers resource.
    - name: cluster_addr
...
```sql
UPDATE k8s.core.replication_controllers
SET 
...
```sql
REPLACE k8s.core.replication_controllers
SET 
apiVersion = '{{ apiVersion }}',
kind = '{{ kind }}',
metadata = '{{ metadata }}',
...
```sql
DELETE FROM k8s.core.replication_controllers
WHERE name = '{{ name }}' --required
AND namespace = '{{ namespace }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
