...
Creates, updates, deletes, gets or lists a <code>pods</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pods" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.pods" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>list or watch objects of kind Pod</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified Pod</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of Pod</td>
</tr>
</tbody>
</table>
...
- name: pods
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the pods resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the pods resource.
    - name: cluster_addr
