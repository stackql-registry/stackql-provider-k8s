...
Creates, updates, deletes, gets or lists a <code>service_accounts_token</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="service_accounts_token" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.service_accounts_token" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>create token of a ServiceAccount</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-name">
    ...
    <td><code>string</code></td>
    <td>name of the TokenRequest</td>
</tr>
...
```sql
INSERT INTO k8s.core.service_accounts_token (
apiVersion,
kind,
metadata,
spec,
...
- name: service_accounts_token
  props:
    - name: name
      value: "{{ name }}"
      description: Required parameter for the service_accounts_token resource.
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the service_accounts_token resource.
    - name: protocol
