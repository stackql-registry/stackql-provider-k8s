...
Creates, updates, deletes, gets or lists a <code>pod_templates</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pod_templates" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.pod_templates" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified PodTemplate</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind PodTemplate</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified PodTemplate</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified PodTemplate</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of PodTemplate</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.core.pod_templates (
apiVersion,
kind,
metadata,
template,
...
- name: pod_templates
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the pod_templates resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the pod_templates resource.
    - name: cluster_addr
...
```sql
REPLACE k8s.core.pod_templates
SET 
apiVersion = '{{ apiVersion }}',
kind = '{{ kind }}',
metadata = '{{ metadata }}',
...
```sql
DELETE FROM k8s.core.pod_templates
WHERE name = '{{ name }}' --required
AND namespace = '{{ namespace }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
