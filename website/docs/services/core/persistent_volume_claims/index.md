...
Creates, updates, deletes, gets or lists a <code>persistent_volume_claims</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="persistent_volume_claims" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.persistent_volume_claims" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified PersistentVolumeClaim</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind PersistentVolumeClaim</td>
</tr>
<tr>
    ...
    <td>create a PersistentVolumeClaim</td>
</tr>
<tr>
    ...
    <td>partially update the specified PersistentVolumeClaim</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified PersistentVolumeClaim</td>
</tr>
<tr>
    ...
    <td>delete a PersistentVolumeClaim</td>
</tr>
<tr>
    ...
    <td>delete collection of PersistentVolumeClaim</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.core.persistent_volume_claims
...
```sql
INSERT INTO k8s.core.persistent_volume_claims (
api_version,
kind,
metadata,
spec,
...
- name: persistent_volume_claims
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the persistent_volume_claims resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the persistent_volume_claims resource.
    - name: cluster_addr
...
```sql
UPDATE k8s.core.persistent_volume_claims
SET 
...
```sql
REPLACE k8s.core.persistent_volume_claims
SET 
...
```sql
DELETE FROM k8s.core.persistent_volume_claims
WHERE name = '{{ name }}' --required
AND namespace = '{{ namespace }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
