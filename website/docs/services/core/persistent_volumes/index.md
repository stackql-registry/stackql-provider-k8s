...
Creates, updates, deletes, gets or lists a <code>persistent_volumes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="persistent_volumes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.persistent_volumes" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified PersistentVolume</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind PersistentVolume</td>
</tr>
<tr>
    ...
    <td>create a PersistentVolume</td>
</tr>
<tr>
    ...
    <td>partially update the specified PersistentVolume</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified PersistentVolume</td>
</tr>
<tr>
    ...
    <td>delete a PersistentVolume</td>
</tr>
<tr>
    ...
    <td>delete collection of PersistentVolume</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.core.persistent_volumes (
api_version,
kind,
metadata,
spec,
...
- name: persistent_volumes
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the persistent_volumes resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the persistent_volumes resource.
    - name: api_version
...
```sql
UPDATE k8s.core.persistent_volumes
SET 
...
```sql
REPLACE k8s.core.persistent_volumes
SET 
...
```sql
DELETE FROM k8s.core.persistent_volumes
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
