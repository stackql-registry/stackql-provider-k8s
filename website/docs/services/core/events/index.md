...
<tr>
    <td><CopyableCode code="firstTimestamp" /></td>
    <td><code>string (date-time)</code></td>
    <td>The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)</td>
</tr>
<tr>
    <td><CopyableCode code="involvedObject" /></td>
    <td><code>object</code></td>
    <td>The object that this event is about. (x-kubernetes-map-type: atomic)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="lastTimestamp" /></td>
    <td><code>string (date-time)</code></td>
...
<tr>
    <td><CopyableCode code="reportingComponent" /></td>
    <td><code>string</code></td>
    <td>Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`. (default: )</td>
</tr>
<tr>
    <td><CopyableCode code="reportingInstance" /></td>
    <td><code>string</code></td>
    <td>ID of the controller instance, e.g. `kubelet-xyzf`. (default: )</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-metadata"><code>metadata</code></a>, <a href="#parameter-involvedObject"><code>involvedObject</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-metadata"><code>metadata</code></a>, <a href="#parameter-involvedObject"><code>involvedObject</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
...
AND involvedObject = '{{ involvedObject }}' --required
AND dryRun = '{{ dryRun}}'
AND fieldManager = '{{ fieldManager}}'
AND fieldValidation = '{{ fieldValidation}}'
AND pretty = '{{ pretty}}'
