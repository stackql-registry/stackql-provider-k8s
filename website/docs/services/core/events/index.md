...
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.events" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Time when this Event was first observed. (wire: eventTime)</td>
</tr>
<tr>
    <td><CopyableCode code="first_timestamp" /></td>
    <td><code>string (date-time)</code></td>
    <td>The time at which the event was first recorded. (Time of server receipt is in TypeMeta.) (wire: firstTimestamp)</td>
</tr>
<tr>
    <td><CopyableCode code="involved_object" /></td>
    <td><code>object</code></td>
    <td>The object that this event is about. (x-kubernetes-map-type: atomic) (wire: involvedObject)</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="last_timestamp" /></td>
    <td><code>string (date-time)</code></td>
    <td>The time at which the most recent occurrence of this event was recorded. (wire: lastTimestamp)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>object</code></td>
    <td>Optional secondary object for more complex actions. (x-kubernetes-map-type: atomic)</td>
</tr>
<tr>
    <td><CopyableCode code="reporting_component" /></td>
    <td><code>string</code></td>
    <td>Name of the controller that emitted this Event, e.g. `kubernetes.io/kubelet`. (default: ) (wire: reportingComponent)</td>
</tr>
<tr>
    <td><CopyableCode code="reporting_instance" /></td>
    <td><code>string</code></td>
    <td>ID of the controller instance, e.g. `kubelet-xyzf`. (default: ) (wire: reportingInstance)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-metadata"><code>metadata</code></a>, <a href="#parameter-involved_object"><code>involved_object</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-metadata"><code>metadata</code></a>, <a href="#parameter-involved_object"><code>involved_object</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
...
AND involved_object = '{{ involved_object }}' --required
AND dry_run = '{{ dry_run}}'
AND field_manager = '{{ field_manager}}'
AND field_validation = '{{ field_validation}}'
AND pretty = '{{ pretty}}'
