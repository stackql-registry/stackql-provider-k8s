...
Creates, updates, deletes, gets or lists a <code>pods_proxy</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pods_proxy" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.core.pods_proxy" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>connect DELETE requests to proxy of Pod</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-path"><code>path</code></a></td>
    <td>connect GET requests to proxy of Pod</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-path"><code>path</code></a></td>
    <td>connect PATCH requests to proxy of Pod</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-path"><code>path</code></a></td>
    <td>connect POST requests to proxy of Pod</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-path"><code>path</code></a></td>
    <td>connect PUT requests to proxy of Pod</td>
</tr>
<tr>
...
```sql
EXEC k8s.core.pods_proxy.connect_get 
@name='{{ name }}' --required, 
@namespace='{{ namespace }}' --required, 
@protocol='{{ protocol }}' --required, 
@cluster_addr='{{ cluster_addr }}' --required, 
...
```sql
EXEC k8s.core.pods_proxy.connect_patch 
@name='{{ name }}' --required, 
@namespace='{{ namespace }}' --required, 
@protocol='{{ protocol }}' --required, 
@cluster_addr='{{ cluster_addr }}' --required, 
...
```sql
EXEC k8s.core.pods_proxy.connect_post 
@name='{{ name }}' --required, 
@namespace='{{ namespace }}' --required, 
@protocol='{{ protocol }}' --required, 
@cluster_addr='{{ cluster_addr }}' --required, 
...
```sql
EXEC k8s.core.pods_proxy.connect_put 
@name='{{ name }}' --required, 
@namespace='{{ namespace }}' --required, 
@protocol='{{ protocol }}' --required, 
@cluster_addr='{{ cluster_addr }}' --required, 
...
```sql
EXEC k8s.core.pods_proxy.connect_delete_path 
@name='{{ name }}' --required, 
@namespace='{{ namespace }}' --required, 
@path='{{ path }}' --required, 
@protocol='{{ protocol }}' --required, 
...
```sql
EXEC k8s.core.pods_proxy.connect_get_path 
@name='{{ name }}' --required, 
@namespace='{{ namespace }}' --required, 
@path='{{ path }}' --required, 
@protocol='{{ protocol }}' --required, 
...
```sql
EXEC k8s.core.pods_proxy.connect_patch_path 
@name='{{ name }}' --required, 
@namespace='{{ namespace }}' --required, 
@path='{{ path }}' --required, 
@protocol='{{ protocol }}' --required, 
...
```sql
EXEC k8s.core.pods_proxy.connect_post_path 
@name='{{ name }}' --required, 
@namespace='{{ namespace }}' --required, 
@path='{{ path }}' --required, 
@protocol='{{ protocol }}' --required, 
...
```sql
EXEC k8s.core.pods_proxy.connect_put_path 
@name='{{ name }}' --required, 
@namespace='{{ namespace }}' --required, 
@path='{{ path }}' --required, 
@protocol='{{ protocol }}' --required, 
