...
Creates, updates, deletes, gets or lists an <code>endpoint_slices</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="endpoint_slices" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.discovery.endpoint_slices" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>addressType specifies the type of address carried by this EndpointSlice. All addresses in this slice must be the same type. This field is immutable after creation. The following address types are currently supported: * IPv4: Represents an IPv4 Address. * IPv6: Represents an IPv6 Address. * FQDN: Represents a Fully Qualified Domain Name. (Deprecated) The EndpointSlice controller only generates, and kube-proxy only processes, slices of addressType "IPv4" and "IPv6". No semantics are defined for the "FQDN" type. (default: ) (wire: addressType)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>read the specified EndpointSlice</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-address_type"><code>address_type</code></a></td>
...
<tr>
    ...
    <td>partially update the specified EndpointSlice</td>
</tr>
<tr>
    <td><a href="#replace"><CopyableCode code="replace" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-address_type"><code>address_type</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified EndpointSlice</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of EndpointSlice</td>
</tr>
</tbody>
</table>
...
metadata,
ports
FROM k8s.discovery.endpoint_slices
...
```sql
INSERT INTO k8s.discovery.endpoint_slices (
address_type,
api_version,
endpoints,
kind,
...
- name: endpoint_slices
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the endpoint_slices resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the endpoint_slices resource.
    - name: cluster_addr
...
```sql
UPDATE k8s.discovery.endpoint_slices
SET 
...
```sql
REPLACE k8s.discovery.endpoint_slices
SET 
...
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND address_type = '{{ address_type }}' --required
AND dry_run = '{{ dry_run}}'
AND field_manager = '{{ field_manager}}'
AND field_validation = '{{ field_validation}}'
AND pretty = '{{ pretty}}'
...
```sql
DELETE FROM k8s.discovery.endpoint_slices
WHERE name = '{{ name }}' --required
AND namespace = '{{ namespace }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
