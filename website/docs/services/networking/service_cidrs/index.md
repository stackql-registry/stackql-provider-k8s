...
Creates, updates, deletes, gets or lists a <code>service_cidrs</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="service_cidrs" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.networking.service_cidrs" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified ServiceCIDR</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind ServiceCIDR</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified ServiceCIDR</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified ServiceCIDR</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of ServiceCIDR</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.networking.service_cidrs
...
```sql
INSERT INTO k8s.networking.service_cidrs (
apiVersion,
kind,
metadata,
spec,
...
- name: service_cidrs
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the service_cidrs resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the service_cidrs resource.
    - name: apiVersion
...
```sql
UPDATE k8s.networking.service_cidrs
SET 
...
```sql
REPLACE k8s.networking.service_cidrs
SET 
apiVersion = '{{ apiVersion }}',
kind = '{{ kind }}',
metadata = '{{ metadata }}',
...
```sql
DELETE FROM k8s.networking.service_cidrs
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dryRun = '{{ dryRun }}'
