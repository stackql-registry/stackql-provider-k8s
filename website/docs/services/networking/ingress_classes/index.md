...
Creates, updates, deletes, gets or lists an <code>ingress_classes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="ingress_classes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.networking.ingress_classes" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified IngressClass</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind IngressClass</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified IngressClass</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified IngressClass</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of IngressClass</td>
</tr>
</tbody>
</table>
...
metadata,
spec
FROM k8s.networking.ingress_classes
...
```sql
INSERT INTO k8s.networking.ingress_classes (
apiVersion,
kind,
metadata,
spec,
...
- name: ingress_classes
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the ingress_classes resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the ingress_classes resource.
    - name: apiVersion
...
```sql
UPDATE k8s.networking.ingress_classes
SET 
...
```sql
REPLACE k8s.networking.ingress_classes
SET 
apiVersion = '{{ apiVersion }}',
kind = '{{ kind }}',
metadata = '{{ metadata }}',
...
```sql
DELETE FROM k8s.networking.ingress_classes
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dryRun = '{{ dryRun }}'
