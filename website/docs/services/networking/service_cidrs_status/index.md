--- 
title: service_cidrs_status
hide_title: false
hide_table_of_contents: false
keywords:
  - service_cidrs_status
  - networking
  - k8s
...
Creates, updates, deletes, gets or lists a <code>service_cidrs_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="service_cidrs_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.networking.service_cidrs_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified ServiceCIDR</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified ServiceCIDR</td>
</tr>
<tr>
    ...
    <td>replace status of the specified ServiceCIDR</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.networking.service_cidrs_status
...
```sql
UPDATE k8s.networking.service_cidrs_status
SET 
...
```sql
REPLACE k8s.networking.service_cidrs_status
SET 
