...
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.networking.ip_addresses" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified IPAddress</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind IPAddress</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified IPAddress</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified IPAddress</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of IPAddress</td>
</tr>
</tbody>
</table>
...
metadata,
spec
FROM k8s.networking.ip_addresses
...
```sql
INSERT INTO k8s.networking.ip_addresses (
api_version,
kind,
metadata,
spec,
...
```sql
UPDATE k8s.networking.ip_addresses
SET 
...
```sql
REPLACE k8s.networking.ip_addresses
SET 
...
```sql
DELETE FROM k8s.networking.ip_addresses
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
