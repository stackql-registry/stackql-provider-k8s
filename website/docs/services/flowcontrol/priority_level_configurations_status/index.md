--- 
title: priority_level_configurations_status
hide_title: false
hide_table_of_contents: false
keywords:
  - priority_level_configurations_status
  - flowcontrol
  - k8s
...
Creates, updates, deletes, gets or lists a <code>priority_level_configurations_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="priority_level_configurations_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.flowcontrol.priority_level_configurations_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified PriorityLevelConfiguration</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified PriorityLevelConfiguration</td>
</tr>
<tr>
    ...
    <td>replace status of the specified PriorityLevelConfiguration</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.flowcontrol.priority_level_configurations_status
...
```sql
UPDATE k8s.flowcontrol.priority_level_configurations_status
SET 
...
```sql
REPLACE k8s.flowcontrol.priority_level_configurations_status
SET 
