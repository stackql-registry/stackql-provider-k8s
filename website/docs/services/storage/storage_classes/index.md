...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="storage_classes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.storage.storage_classes" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><CopyableCode code="allow_volume_expansion" /></td>
    <td><code>boolean</code></td>
    <td>allowVolumeExpansion shows whether the storage class allow volume expand. (wire: allowVolumeExpansion)</td>
</tr>
<tr>
    <td><CopyableCode code="allowed_topologies" /></td>
    <td><code>array</code></td>
    <td>allowedTopologies restrict the node topologies where volumes can be dynamically provisioned. Each volume plugin defines its own supported topology specifications. An empty TopologySelectorTerm list means there is no topology restriction. This field is only honored by servers that enable the VolumeScheduling feature. (x-kubernetes-list-type: atomic) (wire: allowedTopologies)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>array</code></td>
    <td>mountOptions controls the mountOptions for dynamically provisioned PersistentVolumes of this storage class. e.g. &#91;"ro", "soft"&#93;. Not validated - mount of the PVs will simply fail if one is invalid. (x-kubernetes-list-type: atomic) (wire: mountOptions)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>provisioner indicates the type of the provisioner. (default: )</td>
</tr>
<tr>
    <td><CopyableCode code="reclaim_policy" /></td>
    <td><code>string</code></td>
    <td>reclaimPolicy controls the reclaimPolicy for dynamically provisioned PersistentVolumes of this storage class. Defaults to Delete. (wire: reclaimPolicy)</td>
</tr>
<tr>
    <td><CopyableCode code="volume_binding_mode" /></td>
    <td><code>string</code></td>
    <td>volumeBindingMode indicates how PersistentVolumeClaims should be provisioned and bound.  When unset, VolumeBindingImmediate is used. This field is only honored by servers that enable the VolumeScheduling feature. (wire: volumeBindingMode)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-provisioner"><code>provisioner</code></a></td>
...
<tr>
    ...
    <td>partially update the specified StorageClass</td>
</tr>
<tr>
    <td><a href="#replace"><CopyableCode code="replace" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-provisioner"><code>provisioner</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified StorageClass</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of StorageClass</td>
</tr>
</tbody>
</table>
...
reclaim_policy,
volume_binding_mode
FROM k8s.storage.storage_classes
...
```sql
INSERT INTO k8s.storage.storage_classes (
allow_volume_expansion,
allowed_topologies,
api_version,
kind,
...
```sql
UPDATE k8s.storage.storage_classes
SET 
...
```sql
REPLACE k8s.storage.storage_classes
SET 
...
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND provisioner = '{{ provisioner }}' --required
AND dry_run = '{{ dry_run}}'
AND field_manager = '{{ field_manager}}'
AND field_validation = '{{ field_validation}}'
AND pretty = '{{ pretty}}'
...
```sql
DELETE FROM k8s.storage.storage_classes
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
