...
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.storage.volume_attachments" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified VolumeAttachment</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind VolumeAttachment</td>
</tr>
<tr>
    ...
    <td>create a VolumeAttachment</td>
</tr>
<tr>
    ...
    <td>partially update the specified VolumeAttachment</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified VolumeAttachment</td>
</tr>
<tr>
    ...
    <td>delete a VolumeAttachment</td>
</tr>
<tr>
    ...
    <td>delete collection of VolumeAttachment</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.storage.volume_attachments
...
```sql
INSERT INTO k8s.storage.volume_attachments (
api_version,
kind,
metadata,
spec,
...
```sql
UPDATE k8s.storage.volume_attachments
SET 
...
```sql
REPLACE k8s.storage.volume_attachments
SET 
...
```sql
DELETE FROM k8s.storage.volume_attachments
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
