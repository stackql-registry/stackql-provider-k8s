...
Creates, updates, deletes, gets or lists a <code>csi_storage_capacities</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="csi_storage_capacities" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.storage.csi_storage_capacities" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="maximumVolumeSize" /></td>
    <td><code>string</code></td>
...
<tr>
    <td><CopyableCode code="nodeTopology" /></td>
    <td><code>object</code></td>
    <td>nodeTopology defines which nodes have access to the storage for which capacity was reported. If not set, the storage is not accessible from any node in the cluster. If empty, the storage is accessible from all nodes. This field is immutable. (x-kubernetes-map-type: atomic)</td>
</tr>
<tr>
    <td><CopyableCode code="storageClassName" /></td>
    <td><code>string</code></td>
    <td>storageClassName represents the name of the StorageClass that the reported capacity applies to. It must meet the same requirements as the name of a StorageClass object (non-empty, DNS subdomain). If that object no longer exists, the CSIStorageCapacity object is obsolete and should be removed by its creator. This field is immutable. (default: )</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td>read the specified CSIStorageCapacity</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-storageClassName"><code>storageClassName</code></a></td>
    ...
    <td>create a CSIStorageCapacity</td>
</tr>
<tr>
    ...
    <td>partially update the specified CSIStorageCapacity</td>
</tr>
<tr>
    <td><a href="#replace"><CopyableCode code="replace" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-storageClassName"><code>storageClassName</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified CSIStorageCapacity</td>
</tr>
<tr>
    ...
    <td>delete a CSIStorageCapacity</td>
</tr>
<tr>
    ...
    <td>delete collection of CSIStorageCapacity</td>
</tr>
</tbody>
</table>
...
nodeTopology,
storageClassName
FROM k8s.storage.csi_storage_capacities
...
```sql
INSERT INTO k8s.storage.csi_storage_capacities (
apiVersion,
capacity,
kind,
maximumVolumeSize,
...
- name: csi_storage_capacities
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the csi_storage_capacities resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the csi_storage_capacities resource.
    - name: cluster_addr
...
```sql
UPDATE k8s.storage.csi_storage_capacities
SET 
...
```sql
REPLACE k8s.storage.csi_storage_capacities
SET 
apiVersion = '{{ apiVersion }}',
capacity = '{{ capacity }}',
kind = '{{ kind }}',
...
```sql
DELETE FROM k8s.storage.csi_storage_capacities
WHERE name = '{{ name }}' --required
AND namespace = '{{ namespace }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
