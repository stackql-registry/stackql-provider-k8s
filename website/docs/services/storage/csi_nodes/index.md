...
Creates, updates, deletes, gets or lists a <code>csi_nodes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="csi_nodes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.storage.csi_nodes" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified CSINode</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind CSINode</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified CSINode</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified CSINode</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of CSINode</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.storage.csi_nodes (
api_version,
kind,
metadata,
spec,
...
- name: csi_nodes
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the csi_nodes resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the csi_nodes resource.
    - name: api_version
...
```sql
DELETE FROM k8s.storage.csi_nodes
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
