...
<tr>
    <td><CopyableCode code="driverName" /></td>
    <td><code>string</code></td>
    <td>Name of the CSI driver This field is immutable. (default: )</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-driverName"><code>driverName</code></a></td>
...
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-driverName"><code>driverName</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
...
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND driverName = '{{ driverName }}' --required
AND dryRun = '{{ dryRun}}'
AND fieldManager = '{{ fieldManager}}'
AND fieldValidation = '{{ fieldValidation}}'
AND pretty = '{{ pretty}}'
