--- 
title: volume_attributes_classes
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>volume_attributes_classes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="volume_attributes_classes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.storage.volume_attributes_classes" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><CopyableCode code="driver_name" /></td>
    <td><code>string</code></td>
    <td>Name of the CSI driver This field is immutable. (default: ) (wire: driverName)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>read the specified VolumeAttributesClass</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind VolumeAttributesClass</td>
</tr>
<tr>
    <td><a href="#create"><CopyableCode code="create" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-driver_name"><code>driver_name</code></a></td>
    ...
    <td>create a VolumeAttributesClass</td>
</tr>
<tr>
    ...
    <td>partially update the specified VolumeAttributesClass</td>
</tr>
<tr>
    <td><a href="#replace"><CopyableCode code="replace" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-driver_name"><code>driver_name</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified VolumeAttributesClass</td>
</tr>
<tr>
    ...
    <td>delete a VolumeAttributesClass</td>
</tr>
<tr>
    ...
    <td>delete collection of VolumeAttributesClass</td>
</tr>
</tbody>
</table>
...
metadata,
parameters
FROM k8s.storage.volume_attributes_classes
...
```sql
INSERT INTO k8s.storage.volume_attributes_classes (
api_version,
driver_name,
kind,
metadata,
...
- name: volume_attributes_classes
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the volume_attributes_classes resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the volume_attributes_classes resource.
    - name: api_version
...
```sql
UPDATE k8s.storage.volume_attributes_classes
SET 
...
```sql
REPLACE k8s.storage.volume_attributes_classes
SET 
...
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND driver_name = '{{ driver_name }}' --required
AND dry_run = '{{ dry_run}}'
AND field_manager = '{{ field_manager}}'
AND field_validation = '{{ field_validation}}'
AND pretty = '{{ pretty}}'
...
```sql
DELETE FROM k8s.storage.volume_attributes_classes
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
