--- 
title: volume_attachments_status
hide_title: false
hide_table_of_contents: false
keywords:
  - volume_attachments_status
  - storage
  - k8s
...
Creates, updates, deletes, gets or lists a <code>volume_attachments_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="volume_attachments_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.storage.volume_attachments_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified VolumeAttachment</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified VolumeAttachment</td>
</tr>
<tr>
    ...
    <td>replace status of the specified VolumeAttachment</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.storage.volume_attachments_status
...
```sql
UPDATE k8s.storage.volume_attachments_status
SET 
...
```sql
REPLACE k8s.storage.volume_attachments_status
SET 
