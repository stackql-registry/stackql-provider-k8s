...
Creates, updates, deletes, gets or lists a <code>csi_drivers</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="csi_drivers" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.storage.csi_drivers" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified CSIDriver</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind CSIDriver</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified CSIDriver</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified CSIDriver</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of CSIDriver</td>
</tr>
</tbody>
</table>
...
```sql
INSERT INTO k8s.storage.csi_drivers (
apiVersion,
kind,
metadata,
spec,
...
- name: csi_drivers
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the csi_drivers resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the csi_drivers resource.
    - name: apiVersion
...
```sql
UPDATE k8s.storage.csi_drivers
SET 
...
```sql
REPLACE k8s.storage.csi_drivers
SET 
apiVersion = '{{ apiVersion }}',
kind = '{{ kind }}',
metadata = '{{ metadata }}',
...
```sql
DELETE FROM k8s.storage.csi_drivers
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dryRun = '{{ dryRun }}'
