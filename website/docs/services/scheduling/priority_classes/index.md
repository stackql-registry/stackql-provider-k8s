...
Creates, updates, deletes, gets or lists a <code>priority_classes</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="priority_classes" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.scheduling.priority_classes" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="preemption_policy" /></td>
    <td><code>string</code></td>
    <td>preemptionPolicy is the Policy for preempting pods with lower priority. One of Never, PreemptLowerPriority. Defaults to PreemptLowerPriority if unset. (wire: preemptionPolicy)</td>
</tr>
<tr>
...
<tr>
    ...
    <td>read the specified PriorityClass</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind PriorityClass</td>
</tr>
<tr>
...
<tr>
    ...
    <td>partially update the specified PriorityClass</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a></td>
    <td><a href="#parameter-dry_run"><code>dry_run</code></a>, <a href="#parameter-field_manager"><code>field_manager</code></a>, <a href="#parameter-field_validation"><code>field_validation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified PriorityClass</td>
</tr>
<tr>
...
<tr>
    ...
    <td>delete collection of PriorityClass</td>
</tr>
</tbody>
</table>
...
preemption_policy,
value
FROM k8s.scheduling.priority_classes
...
```sql
INSERT INTO k8s.scheduling.priority_classes (
api_version,
description,
global_default,
kind,
...
- name: priority_classes
  props:
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the priority_classes resource.
    - name: cluster_addr
      value: "{{ cluster_addr }}"
      description: Required parameter for the priority_classes resource.
    - name: api_version
...
```sql
UPDATE k8s.scheduling.priority_classes
SET 
...
```sql
REPLACE k8s.scheduling.priority_classes
SET 
...
```sql
DELETE FROM k8s.scheduling.priority_classes
WHERE name = '{{ name }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
AND dry_run = '{{ dry_run }}'
