...
Creates, updates, deletes, gets or lists a <code>controller_revisions</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="controller_revisions" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.apps.controller_revisions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read the specified ControllerRevision</td>
</tr>
<tr>
    ...
    <td>list or watch objects of kind ControllerRevision</td>
</tr>
<tr>
    <td><a href="#create"><CopyableCode code="create" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-revision"><code>revision</code></a></td>
    ...
    <td>create a ControllerRevision</td>
</tr>
<tr>
    ...
    <td>partially update the specified ControllerRevision</td>
</tr>
<tr>
    <td><a href="#replace"><CopyableCode code="replace" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-namespace"><code>namespace</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-cluster_addr"><code>cluster_addr</code></a>, <a href="#parameter-revision"><code>revision</code></a></td>
    <td><a href="#parameter-dryRun"><code>dryRun</code></a>, <a href="#parameter-fieldManager"><code>fieldManager</code></a>, <a href="#parameter-fieldValidation"><code>fieldValidation</code></a>, <a href="#parameter-pretty"><code>pretty</code></a></td>
    <td>replace the specified ControllerRevision</td>
</tr>
<tr>
    ...
    <td>delete a ControllerRevision</td>
</tr>
<tr>
    ...
    <td>delete collection of ControllerRevision</td>
</tr>
</tbody>
</table>
...
metadata,
revision
FROM k8s.apps.controller_revisions
...
```sql
INSERT INTO k8s.apps.controller_revisions (
apiVersion,
data,
kind,
metadata,
...
- name: controller_revisions
  props:
    - name: namespace
      value: "{{ namespace }}"
      description: Required parameter for the controller_revisions resource.
    - name: protocol
      value: "{{ protocol }}"
      description: Required parameter for the controller_revisions resource.
    - name: cluster_addr
...
```sql
UPDATE k8s.apps.controller_revisions
SET 
...
```sql
REPLACE k8s.apps.controller_revisions
SET 
apiVersion = '{{ apiVersion }}',
data = '{{ data }}',
kind = '{{ kind }}',
...
```sql
DELETE FROM k8s.apps.controller_revisions
WHERE name = '{{ name }}' --required
AND namespace = '{{ namespace }}' --required
AND protocol = '{{ protocol }}' --required
AND cluster_addr = '{{ cluster_addr }}' --required
