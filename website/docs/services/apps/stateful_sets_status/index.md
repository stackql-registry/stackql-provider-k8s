--- 
title: stateful_sets_status
hide_title: false
hide_table_of_contents: false
keywords:
  - stateful_sets_status
  - apps
  - k8s
...
Creates, updates, deletes, gets or lists a <code>stateful_sets_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="stateful_sets_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.apps.stateful_sets_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified StatefulSet</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified StatefulSet</td>
</tr>
<tr>
    ...
    <td>replace status of the specified StatefulSet</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.apps.stateful_sets_status
...
```sql
UPDATE k8s.apps.stateful_sets_status
SET 
...
```sql
REPLACE k8s.apps.stateful_sets_status
SET 
