...
Creates, updates, deletes, gets or lists a <code>daemon_sets_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="daemon_sets_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.apps.daemon_sets_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified DaemonSet</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified DaemonSet</td>
</tr>
<tr>
    ...
    <td>replace status of the specified DaemonSet</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.apps.daemon_sets_status
...
```sql
UPDATE k8s.apps.daemon_sets_status
SET 
...
```sql
REPLACE k8s.apps.daemon_sets_status
SET 
