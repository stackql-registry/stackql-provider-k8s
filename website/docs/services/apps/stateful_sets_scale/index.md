...
Creates, updates, deletes, gets or lists a <code>stateful_sets_scale</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="stateful_sets_scale" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.apps.stateful_sets_scale" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read scale of the specified StatefulSet</td>
</tr>
<tr>
    ...
    <td>partially update scale of the specified StatefulSet</td>
</tr>
<tr>
    ...
    <td>replace scale of the specified StatefulSet</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.apps.stateful_sets_scale
...
```sql
UPDATE k8s.apps.stateful_sets_scale
SET 
...
```sql
REPLACE k8s.apps.stateful_sets_scale
SET 
