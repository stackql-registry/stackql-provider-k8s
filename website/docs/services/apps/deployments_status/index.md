...
Creates, updates, deletes, gets or lists a <code>deployments_status</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="deployments_status" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="k8s.apps.deployments_status" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>read status of the specified Deployment</td>
</tr>
<tr>
    ...
    <td>partially update status of the specified Deployment</td>
</tr>
<tr>
    ...
    <td>replace status of the specified Deployment</td>
</tr>
</tbody>
</table>
...
spec,
status
FROM k8s.apps.deployments_status
...
```sql
UPDATE k8s.apps.deployments_status
SET 
...
```sql
REPLACE k8s.apps.deployments_status
SET 
